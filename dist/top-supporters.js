  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(items) {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          list = document.getElementById('supporter-list');
          list.innerHTML = '';
        ...
        case 3:
          ...
          spanScore.textContent = "Amount: ".concat(item.total);
...
var showMessage = function showMessage(msg) {
  var list = document.getElementById('supporter-list');
  if (list) {
      ...
      while (1) switch (_context3.n) {
        case 0:
          ...
          return (0, _firebase.withRetry)(function () {
            return (0, _firebaseFirestore.getDoc)((0, _firebaseFirestore.doc)(_firebase.db, 'stats', 'topSupporters'));
          });
        case 1:
          snap = _context3.v;
          if (snap.exists()) {
