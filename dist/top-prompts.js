...
var fetchPromptText = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.n) {
        case 0:
          ...
          return (0, _firebase.withRetry)(function () {
            return (0, _firebaseFirestore.getDoc)((0, _firebaseFirestore.doc)(_firebase.db, 'prompts', id));
          });
        case 1:
          snap = _context.v;
          return _context.a(2, snap.exists() ? snap.data().text : id);
        case 2:
          _context.p = 2;
          _t = _context.v;
  ...
  return function fetchPromptText(_x) {
...
var render = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(items) {
    var _window$lucide;
    var list, _iterator, _step, item, text, card, p, score, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 2:
          ...
          item = _step.value;
          _context2.n = 3;
          return fetchPromptText(item.id);
        case 3:
          text = _context2.v;
          ...
          score.textContent = "Score: ".concat(item.score);
          card.appendChild(p);
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          _context3.n = 1;
          return (0, _firebase.withRetry)(function () {
            return (0, _firebaseFirestore.getDoc)((0, _firebaseFirestore.doc)(_firebase.db, 'stats', 'topPrompts'));
          });
        case 1:
          snap = _context3.v;
          if (snap.exists()) {
