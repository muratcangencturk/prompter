...
var render = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(items) {
    var _window$lucide;
    var list, _iterator, _step, item, name, el, spanName, spanSince, dateStr, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          list = document.getElementById('pro-list');
          list.innerHTML = '';
        ...
        case 3:
          ...
          spanSince = document.createElement('span');
          spanSince.className = 'text-xs text-blue-200';
          dateStr = new Date(item.since).toLocaleDateString();
          spanSince.textContent = "Since: ".concat(dateStr);
      ...
      while (1) switch (_context3.n) {
        case 0:
          ...
          return (0, _firebase.withRetry)(function () {
            return (0, _firebaseFirestore.getDoc)((0, _firebaseFirestore.doc)(_firebase.db, 'stats', 'longestPro'));
          });
        case 1:
          snap = _context3.v;
          if (snap.exists()) {
