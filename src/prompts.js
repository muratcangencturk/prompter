...
export const categories = [
  {
    ...
    icon: 'shuffle',
    emoji: '🔀',
    name: { en: 'Random', tr: 'Rastgele', es: 'Aleatorio', zh: '随机' },
  },
  {
    id: 'inspiring',
    icon: 'sunrise',
    emoji: '🌅',
    name: { en: 'Inspiring', tr: 'İlham Verici', es: 'Inspirador', zh: '鼓舞人心' },
  },
  {
    id: 'mindBlowing',
    icon: 'brain-circuit',
    emoji: '🤯',
    name: { en: 'Interesting', tr: 'İlginç', es: 'Interesante', zh: '有趣' },
  },
  {
    id: 'productivity',
    icon: 'zap',
    emoji: '⚡',
    name: { en: 'Productivity', tr: 'Üretkenlik', es: 'Productividad', zh: '生产力' },
  },
  {
    id: 'educational',
    icon: 'graduation-cap',
    emoji: '🎓',
    name: { en: 'Educational', tr: 'Eğitici', es: 'Educativo', zh: '教育' },
  },
  {
    id: 'crazy',
    icon: 'laugh',
    emoji: '😂',
    name: { en: 'Crazy', tr: 'Uçuk', es: 'Ideas Locas', zh: '疯狂' },
  },
  {
    id: 'perspective',
    icon: 'glasses',
    emoji: '🕶️',
    name: { en: 'Perspective', tr: 'Bakış Açısı', es: 'Perspectiva', zh: '视角' },
  },
  {
    id: 'ai',
    icon: 'cpu',
    emoji: '🤖',
    name: { en: 'AI', tr: 'YZ', es: 'IA', zh: '人工智能' },
  },
  {
    id: 'ideas',
    icon: 'lightbulb',
    emoji: '💡',
    name: { en: 'Ideas', tr: 'Fikirler', es: 'Ideas', zh: '创意' },
  },
  {
    id: 'video',
    icon: 'video',
    emoji: '🎬',
    name: { en: 'Video', tr: 'Video', es: 'Video', zh: '视频' },
  },
  {
    id: 'image',
    icon: 'image',
    emoji: '🖼️',
    name: { en: 'Image', tr: 'Görsel', es: 'Imagen', zh: '图像' },
  },
  {
    id: 'hellprompts',
    icon: 'skull',
    emoji: '💀',
    name: { en: 'Hellprompts', tr: 'Hellprompts', es: 'Hellprompts', zh: '地狱提示' },
  },
];
