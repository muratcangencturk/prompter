...
const ASSETS = [
  ...
  'translations/en.json?v=74',
  'translations/es.json?v=74',
  'translations/fr.json?v=74',
  'translations/hi.json?v=74',
  'translations/tr.json?v=74',
  'translations/zh.json?v=74',
  'user.html',
  'zh/404.html',
  'zh/blog.html',
  'zh/dm.html',
